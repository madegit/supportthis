          ...
          <div className="w-full max-w-md p-6 md:p-12">
            <div className="space-y-6">
              <div className="text-center">
                <h2 className="text-xl md:text-2xl font-bold text-white mb-2">Sign In</h2>
                <p className="text-gray-300 text-sm md:text-base">Enter your credentials to access your account</p>
              </div>
