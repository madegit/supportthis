...
export const VisitsChart: React.FC = () => {
  ...
  if (error)
    return (
      <div className="flex items-center justify-center h-100 bg-white dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-xl p-6 shadow border dark:border-gray-800">
  ...
  const thisWeekTotal = formattedData.reduce((sum, day) => sum + day.thisWeek, 0)
  const lastWeekTotal = formattedData.reduce((sum, day) => sum + day.lastWeek, 0)
  ...
  return (
    <div className="bg-white dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-xl p-6 shadow border dark:border-gray-800">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Statistics</h2>
      </div>
      <div className="flex justify-between mb-4">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-gray-900 dark:text-white">{thisWeekTotal} visits</p>
          </div>
        </div>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xl font-bold text-gray-900 dark:text-white">{lastWeekTotal} visits</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center mt-1">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Total Visits Today: <span className="font-semibold text-gray-900 dark:text-white">{todayVisits} visits</span>
        </p>
      </div>
    </div>
  )
